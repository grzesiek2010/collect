...
public class GeoPolyActivity extends LocalizedActivity implements GeoPolySettingsDialogFragment.SettingsDialogCallback {
    ...
    private void updateUi() {
        ...
        locationStatus.setBackgroundColor(
                location == null ? getThemeAttributeValue(this, androidx.appcompat.R.attr.colorPrimary)
                        : acceptable ? getThemeAttributeValue(this, androidx.appcompat.R.attr.colorPrimary)
                        : getThemeAttributeValue(this, androidx.appcompat.R.attr.colorError)
        );
