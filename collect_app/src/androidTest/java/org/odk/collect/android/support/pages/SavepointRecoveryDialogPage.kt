...
class SavepointRecoveryDialogPage : Page<SavepointRecoveryDialogPage>() {
    ...
    fun clickRecover(formName: String): FormEntryPage {
        return this.clickOnButtonInDialog(R.string.recover, FormEntryPage(formName))
    }

    fun clickDoNotRecover(formName: String): FormEntryPage {
        return this.clickOnButtonInDialog(R.string.do_not_recover, FormEntryPage(formName))
    }
}
