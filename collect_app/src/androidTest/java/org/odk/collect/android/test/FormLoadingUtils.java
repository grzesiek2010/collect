...
public class FormLoadingUtils {
    ...
    private static void saveFormToDatabase(File outFile) {
        ...
        v.put(FormsColumns.FORM_FILE_PATH, new StoragePathProvider().getFormDbPath(outFile.getName()));
        v.put(FormsColumns.FORM_MEDIA_PATH, new StoragePathProvider().getFormDbPath(FileUtils.constructMediaPath(outFile.getName())));
