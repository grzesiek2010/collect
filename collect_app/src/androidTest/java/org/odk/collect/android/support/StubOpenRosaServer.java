...
import org.odk.collect.android.formmanagement.FormParserKt;
...
import org.odk.collect.android.formmanagement.FormParser;
...
public class StubOpenRosaServer implements OpenRosaHttpInterface {
    ...
    private void addFormFromInputStream(String formXML, List<MediaFileItem> mediaFiles, InputStream formDefStream) {
        try {
            Document doc = FormParser.parseXml(formDefStream);
            String title = FormParserKt.getTitle(doc);
            Element model = FormParserKt.getModel(doc);
