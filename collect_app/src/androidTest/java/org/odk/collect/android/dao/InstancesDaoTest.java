...
public class InstancesDaoTest {
    ...
    public void getInstancesCursorForFilePathTest() {
        Cursor cursor = instancesDao.getInstancesCursorForFilePath(storagePathProvider.getInstancesDirPath() + "/Hypertension Screening_2017-02-20_14-03-53/Hypertension Screening_2017-02-20_14-03-53.xml");
        List<Instance> instances = instancesDao.getInstancesFromCursor(cursor);
    ...
    public void updateInstanceTest() {
        Cursor cursor = instancesDao.getInstancesCursorForFilePath(storagePathProvider.getInstancesDirPath() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml");
        List<Instance> instances = instancesDao.getInstancesFromCursor(cursor);
        ...
        biggestNOfSetInstance = new Instance.Builder()
                ...
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml")
                .jrFormId("N_Biggest")
        ...
        String[] whereArgs = {storagePathProvider.getInstanceFilePathToStoreInDatabaseBasingOnRelativePath("Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml")};
        ...
        cursor = instancesDao.getInstancesCursorForFilePath(storagePathProvider.getInstancesDirPath() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml");
    ...
    @Test public void deletingSentInstance_keepsItsDatabaseRow_butClearsItsGeometryFields() {
        Instance formWithGeopointInstance = new Instance.Builder()
                ...
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/my/fake/path")
                .status(InstanceProviderAPI.STATUS_SUBMITTED)
        ...
        Cursor cursor = instancesDao.getInstancesCursorForFilePath(storagePathProvider.getInstancesDirPath() + "/my/fake/path");
    ...
    private void fillDatabase() {
        hypertensionScreeningInstance = new Instance.Builder()
                ...
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/Hypertension Screening_2017-02-20_14-03-53/Hypertension Screening_2017-02-20_14-03-53.xml")
        ...
        cascadingSelectInstance = new Instance.Builder()
                ...
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/Cascading Select Form_2017-02-20_14-06-44/Cascading Select Form_2017-02-20_14-06-44.xml")
        ...
        biggestNOfSetInstance = new Instance.Builder()
                .displayName("Biggest N of Set")
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/Biggest N of Set_2017-02-20_14-06-51/Biggest N of Set_2017-02-20_14-06-51.xml")
                .jrFormId("N_Biggest")
                .status(InstanceProviderAPI.STATUS_SUBMITTED)
        ...
        widgetsInstance = new Instance.Builder()
                .displayName("Widgets")
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/Widgets_2017-02-20_14-06-58/Widgets_2017-02-20_14-06-58.xml")
                .jrFormId("widgets")
                .status(InstanceProviderAPI.STATUS_SUBMITTED)
        ...
        sampleInstance = new Instance.Builder()
                .displayName("sample")
                .instanceFilePath(storagePathProvider.getInstancesDirPath() + "/sample_2017-02-20_14-07-03/sample_2017-02-20_14-07-03.xml")
                .jrFormId("sample")
                .status(InstanceProviderAPI.STATUS_INCOMPLETE)
