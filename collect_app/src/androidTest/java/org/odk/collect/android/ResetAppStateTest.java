...
public class ResetAppStateTest {
    ...
    private void setupTestSettings() throws IOException {
        ...
        assertTrue(new File(StorageManager.getMainODKDirPath() + "/collect.settings").createNewFile());
    }

    private void setupTestFormsDatabase() {
        ContentValues values = new ContentValues();
        values.put(FormsColumns.JRCACHE_FILE_PATH, StorageManager.getCacheFilePath("3a76a386464925b6f3e53422673dfe3c.formdef"));
        values.put(FormsColumns.JR_FORM_ID, "jrFormId");
        values.put(FormsColumns.FORM_MEDIA_PATH, StorageManager.getFormMediaFilePath("testFile1-media"));
