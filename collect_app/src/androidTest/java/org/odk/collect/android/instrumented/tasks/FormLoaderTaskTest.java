...
public class FormLoaderTaskTest {
    ...
    public void loadSearchFromExternalCSVmultipleTimes() throws Exception {
        ...
        FormLoaderTask formLoaderTask = new FormLoaderTask(formUri, FormsContract.CONTENT_ITEM_TYPE, null, null, formEntryControllerFactory, mock(), null);
        ...
        formLoaderTask = new FormLoaderTask(formUri, FormsContract.CONTENT_ITEM_TYPE, null, null, formEntryControllerFactory, mock(), null);
