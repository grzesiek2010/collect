...
public class AdminSettingsPage extends Page<AdminSettingsPage> {
    ...
    public GeneralSettingsPage clickGeneralSettings() {
        scrollToRecyclerViewItemAndClickText(getTranslatedString(R.string.general_settings_title));
    ...
    public MainMenuPage deleteProject() {
        scrollToRecyclerViewItemAndClickText(R.string.delete_project_settings_title);
