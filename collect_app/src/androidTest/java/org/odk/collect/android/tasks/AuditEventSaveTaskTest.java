...
public class AuditEventSaveTaskTest {
    ...
    private ArrayList<AuditEvent> getMoreSampleAuditEventsWithLocationsAndTrackingChanges() {
        AuditEvent event;
        ArrayList<AuditEvent> auditEvents = new ArrayList<>();
        event = new AuditEvent(1548108900606L, FORM_RESUME, true, true, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        ...
        auditEvents.add(event);
        event = new AuditEvent(1548108909730L, FORM_SAVE, true, true, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108909730L, FORM_EXIT, true, true, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108909731L, FORM_FINALIZE, true, true, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        return auditEvents;
    }
    ...
    private ArrayList<AuditEvent> getSampleAuditEventsWithLocationsAndTrackingChanges() {
        ArrayList<AuditEvent> auditEvents = new ArrayList<>();
        auditEvents.add(new AuditEvent(1548106927319L, FORM_START, true, true, null, null));
        auditEvents.add(new AuditEvent(548108908250L, LOCATION_TRACKING_ENABLED, true, true, null, null));
        auditEvents.add(new AuditEvent(548108908255L, LOCATION_PERMISSIONS_GRANTED, true, true, null, null));
        auditEvents.add(new AuditEvent(548108908259L, LOCATION_PROVIDERS_ENABLED, true, true, null, null));
        AuditEvent event;
