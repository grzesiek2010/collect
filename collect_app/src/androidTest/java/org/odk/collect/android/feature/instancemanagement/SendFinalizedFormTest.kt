...
class SendFinalizedFormTest {
    ...
    fun formsAreSentInOldestFirstOrder() {
        ...
        val root1 = FormParser.parseXml(testDependencies.server.submissions[0]).rootElement
        val root2 = FormParser.parseXml(testDependencies.server.submissions[1]).rootElement
