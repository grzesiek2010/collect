...
class GoogleDriveProjectsDeleterTest {
    ...
    @Test
    fun `GoogleDriveProjectsDeleter should have non-null key`() {
        assertThat(googleDriveProjectsDeleter.key(), equalTo(MetaKeys.GOOGLE_DRIVE_PROJECTS_WITH_NO_FILLED_FORMS_DELETED))
    }
