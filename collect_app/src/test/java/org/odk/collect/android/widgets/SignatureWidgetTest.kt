...
class SignatureWidgetTest : FileWidgetTest<SignatureWidget>() {
    private var currentFile: File? = null

    override fun createWidget(): SignatureWidget {
    ...
    override fun usingReadOnlyOptionShouldMakeAllClickableElementsDisabled() {
        ...
        assertThat(spyWidget!!.binding.signButton.visibility, equalTo(View.GONE))
    }
    ...
    fun `When there is no answer hide image view and error message`() {
        ...
        assertThat(widget.answerView.visibility, equalTo(View.GONE))
        assertThat(widget.answerView.drawable, nullValue())
    ...
    fun `When prompt has default answer shows in image view`() {
        ...
        val imageView = widget.answerView
    ...
    fun `When prompt has default answer pass uri to draw activity`() {
        ...
        val intent = getIntentLaunchedByClick(R.id.sign_button)
