...
class RangeSliderTest {
    ...
    fun `start, end and current value labels are correctly displayed for integer data`() {
        ...
        composeTestRule
            .onNodeWithContentDescription("Start label")
            .assertIsDisplayed()
            .assertTextEquals("0")

        composeTestRule
            .onNodeWithContentDescription("End label")
            .assertIsDisplayed()
            .assertTextEquals("10")

        composeTestRule
            .onNodeWithContentDescription("Current value label")
            .assertIsDisplayed()
            .assertTextEquals("5")
    }
    ...
    fun `displays thumb when there is answer`() {
        ...
        composeTestRule
            .onNodeWithContentDescription("Thumb")
            .assertIsDisplayed()
    }
    ...
    fun `displays horizontal slider when isHorizontal is true`() {
        ...
        composeTestRule
            .onNodeWithContentDescription("Horizontal slider")
            .assertIsEnabled()
    }
    ...
    fun `displays vertical slider when isHorizontal is false`() {
        ...
        composeTestRule
            .onNodeWithContentDescription("Vertical slider")
            .assertIsEnabled()
    }
    ...
    fun `displays ticks when numOfTicks is greater than 0`() {
        ...
        composeTestRule
            .onAllNodesWithContentDescription("Tick", useUnmergedTree = true)
            .assertCountEquals(3)
    }
