...
class QuitFormDialogTest {
    ...
    @Test
    fun `The 'Save' button should be hidden if 'Save Form' is disabled but 'Ready to Send' is enabled in protected settings`() {
    ...
    @Test
    fun `The 'Save' button should be hidden if 'Save Form' is enabled but 'Ready to Send' is disabled in protected settings`() {
    ...
    @Test
    fun `The 'Save' button should be visible if 'Save Form' and 'Ready to Send' are enabled in protected settings`() {
        settingsProvider.getProtectedSettings().save(ProtectedProjectKeys.KEY_SAVE_MID, true)
        settingsProvider.getProtectedSettings().save(ProtectedProjectKeys.KEY_EDIT_SAVED, true)
        val dialog = showDialog(activity)
