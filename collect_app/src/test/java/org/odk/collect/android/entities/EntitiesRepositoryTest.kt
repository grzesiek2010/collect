...
abstract class EntitiesRepositoryTest {
    ...
    @Test
    fun `#save adds new properties and removes not existing ones`() {
        val repository = buildSubject()
    ...
    @Test
    fun `#save adds new properties and removes not existing ones for lists with dashes`() {
        val repository = buildSubject()
    ...
    @Test
    fun `#save adds new properties and removes not existing ones to existing entities`() {
        val repository = buildSubject()
