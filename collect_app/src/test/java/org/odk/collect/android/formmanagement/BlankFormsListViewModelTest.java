...
public class BlankFormsListViewModelTest {
    ...
    public void isSyncing_followsRepositoryIsSyncing() {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), mock(Scheduler.class), syncRepository, mock(ServerFormsSynchronizer.class), preferencesRepository, mock(Notifier.class), changeLock, analytics);
    ...
    public void syncWithServer_startsSyncOnRepository() {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), fakeScheduler, syncRepository, mock(ServerFormsSynchronizer.class), preferencesRepository, mock(Notifier.class), changeLock, analytics);
    ...
    public void syncWithServer_whenTaskFinishes_finishesSyncOnRepositoryAndNotifies() {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), fakeScheduler, syncRepository, mock(ServerFormsSynchronizer.class), preferencesRepository, notifier, changeLock, analytics);
        viewModel.syncWithServer();
    ...
    public void syncWithServer_whenThereIsAnError_finishesSyncOnRepositoryWithFailureAndSendsErrorToNotifier() throws Exception {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), fakeScheduler, syncRepository, synchronizer, preferencesRepository, notifier, changeLock, analytics);
    ...
    public void syncWithServer_whenThereIsAnError_setsResultToFalse() throws Exception {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), fakeScheduler, syncRepository, synchronizer, preferencesRepository, mock(Notifier.class), changeLock, analytics);
    ...
    public void syncWithServer_whenChangeLockLocked_doesNothing() throws Exception {
        ...
        BlankFormsListViewModel viewModel = new BlankFormsListViewModel(mock(Application.class), fakeScheduler, syncRepository, serverFormsSynchronizer, preferencesRepository, notifier, changeLock, analytics);
    ...
    public void syncWithServer_logsAnalytics() {
        preferencesRepository.getGeneralPreferences().save(GeneralKeys.KEY_SERVER_URL, "https://blah.com/formServer");
