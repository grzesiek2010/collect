...
public class FormInstanceFileCreatorTest {
    ...
    public void createsDirectory_basedOnDefinitionPathAndCurrentTime_inInstancesDirectory() throws Exception {
        ...
        FormInstanceFileCreator instanceFileCreator = new FormInstanceFileCreator(instancesDir, clock);
        instanceFileCreator.createInstanceFileBasedOnFormName("/blah/blah/Cool form name.xml");
    ...
    public void returnsInstanceFile_inInstanceDirectory() throws Exception {
        ...
        FormInstanceFileCreator instanceFileCreator = new FormInstanceFileCreator(instancesDir, clock);
        File instanceFile = instanceFileCreator.createInstanceFileBasedOnFormName("/blah/blah/Cool form name.xml");
    ...
    public void whenCreatingDirFails_returnsNull() throws Exception {
        ...
        FormInstanceFileCreator instanceFileCreator = new FormInstanceFileCreator(tempFile.getAbsolutePath(), clock);
        File instanceFile = instanceFileCreator.createInstanceFileBasedOnFormName("/blah/blah/Cool form name.xml");
