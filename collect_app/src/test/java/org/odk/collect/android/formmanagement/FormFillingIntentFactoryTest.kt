...
import org.odk.collect.android.formentry.FormIntentExtras.FORM_MODE_KEY
import org.odk.collect.android.formentry.FormIntentExtras.FORM_MODE_VIEW_SENT
...
class FormFillingIntentFactoryTest {
    ...
    fun `newInstance starts FormUriActivity with instance URI`() {
        ...
        intended(not(hasExtra(FORM_MODE_KEY, FORM_MODE_VIEW_SENT)))
    }
