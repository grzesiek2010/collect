...
public class AuditEvent {
    ...
    public AuditEvent(long start, AuditEventType auditEventType, boolean isTrackingLocationEnabled,
    ...
    public String toString() {
        ...
        String event;
        if (isTrackingLocationEnabled && isTrackingChangesEnabled) {
        ...
        } else if (isTrackingLocationEnabled) {
