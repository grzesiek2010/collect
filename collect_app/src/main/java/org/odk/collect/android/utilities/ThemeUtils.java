...
public final class ThemeUtils {
    ...
    public int getColorError() {
        return getThemeAttributeValue(context, androidx.appcompat.R.attr.colorError);
    }

    @ColorInt
    public int getColorPrimaryDark() {
        return getThemeAttributeValue(context, androidx.appcompat.R.attr.colorPrimaryDark);
    }
}
