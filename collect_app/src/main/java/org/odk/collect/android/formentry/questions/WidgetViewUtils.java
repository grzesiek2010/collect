    ...
    public static Button createSimpleButton(Context context, @IdRes final int withId, boolean readOnly, String text, ButtonClickListener listener, boolean addMargin) {
        ...
        if (readOnly) {
            ...
            if (addMargin) {
                ...
                float marginStandard = context.getResources().getDimension(org.odk.collect.androidshared.R.dimen.margin_standard);
                params.setMargins(7, (int) marginStandard, 7, 5);
