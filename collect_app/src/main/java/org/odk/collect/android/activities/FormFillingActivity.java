...
import org.odk.collect.android.formentry.savepoint.SavePointListener;
import org.odk.collect.android.formentry.savepoint.SavePointTask;
...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    private void nonblockingCreateSavePointData() {
        try {
            SavePointTask savePointTask = new SavePointTask(this, getFormController(), formSaveViewModel, formLoaderTask.getForm(), formLoaderTask.getInstance(), formsRepositoryProvider.get(), instancesRepositoryProvider.get(), scheduler);
