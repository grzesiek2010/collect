    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        if (view.findViewById(R.id.visible_off).getVisibility() != View.VISIBLE) {
            ...
            if (Intent.ACTION_PICK.equals(action)) {
                ...
                if (parentIntent.getStringExtra(ApplicationConstants.BundleKeys.FORM_MODE.toString()).equalsIgnoreCase(ApplicationConstants.FormModes.EDIT_SAVED.toString())) {
                    intent.putExtra(ApplicationConstants.BundleKeys.FORM_MODE.toString(), ApplicationConstants.FormModes.EDIT_SAVED.toString());
                } else {
                    intent.putExtra(ApplicationConstants.BundleKeys.FORM_MODE.toString(), ApplicationConstants.FormModes.VIEW_SENT.toString());
                }
