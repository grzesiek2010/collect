...
public class ExternalAppIntentProvider {
    ...
    public void provideIntentToRunExternalApp(OnIntentProvided onIntentProvided, Context context, FormEntryPrompt formEntryPrompt, ActivityAvailability activityAvailability) {
