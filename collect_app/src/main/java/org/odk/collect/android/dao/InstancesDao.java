...
public class InstancesDao {
    ...
    public Cursor getSentInstancesCursor() {
        ...
        return Collect.getInstance().getContentResolver().query(InstanceProviderAPI.InstanceColumns.CONTENT_URI, null, selection, selectionArgs, sortOrder);
    }
    ...
    public Cursor getSavedInstancesCursor() {
        String selection = InstanceProviderAPI.InstanceColumns.DELETED_DATE + " IS NULL ";
        String sortOrder = InstanceProviderAPI.InstanceColumns.DISPLAY_NAME + " ASC";

        return Collect.getInstance().getContentResolver().query(InstanceProviderAPI.InstanceColumns.CONTENT_URI, null, selection, null, sortOrder);
    }
    ...
    public Cursor getAllCompletedInstancesCursor() {
    ...
    public Uri saveInstance(Instance instance) {
        return Collect.getInstance().getContentResolver().insert(InstanceProviderAPI.InstanceColumns.CONTENT_URI, getValuesFromInstanceObject(instance));
    }

    public int updateInstance(Instance instance, String where, String[] whereArgs) {
        return Collect.getInstance().getContentResolver().update(InstanceProviderAPI.InstanceColumns.CONTENT_URI, getValuesFromInstanceObject(instance), where, whereArgs);
    }

    public void deleteInstanceDatabase() {
    ...
    private ContentValues getValuesFromInstanceObject(Instance instance) {
