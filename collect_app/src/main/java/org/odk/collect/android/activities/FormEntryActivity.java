...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void loadFromIntent(Intent intent) {
        ...
        if (uriMimeType == null && intent.hasExtra(EXTRA_TESTING_PATH)) {
            ...
            if (formPath == null) {
                ...
                File cacheDir = new File(StorageManager.getCachePath());
                ...
                for (File candidate : files) {
                    ...
                    File instanceDir = new File(
                            StorageManager.getInstancesPath() + File.separator
                                    + instanceDirName);
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        switch (requestCode) {
            ...
            case RequestCodes.IMAGE_CAPTURE:
                ...
                // file
                ImageConverter.execute(StorageManager.TMPFILE_PATH, getWidgetWaitingForBinaryData(), this);
                File fi = new File(StorageManager.TMPFILE_PATH);
    ...
    private void createInstanceDirectory(FormController formController) {
        ...
        String file = formPath.substring(formPath.lastIndexOf('/') + 1,
                formPath.lastIndexOf('.'));
        String path = StorageManager.getInstancesPath() + File.separator + file + "_"
                + time;
