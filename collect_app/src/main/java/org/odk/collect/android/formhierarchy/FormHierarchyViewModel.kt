...
class FormHierarchyViewModel(
    ...
    private val fomInstanceFileCreator: FormInstanceFileCreator
) : ViewModel() {
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return FormHierarchyViewModel(scheduler, instancesDir, instancesRepository, formInstanceFileCreator) as T
        }
    }
}
