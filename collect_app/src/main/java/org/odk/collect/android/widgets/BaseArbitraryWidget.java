...
public abstract class BaseArbitraryWidget extends QuestionWidget implements FileWidget, WidgetDataReceiver  {
    @NonNull
    ...
    public BaseArbitraryWidget(Context context, QuestionDetails questionDetails, @NonNull FileUtil fileUtil, @NonNull MediaUtils mediaUtils,
    ...
    public void setData(Object object) {
        ...
        if (object instanceof Uri) {
            newFile = FileUtils.createDestinationMediaFile(Collect.getInstance().getFormController().getInstanceFile().getParent(), ContentResolverHelper.getFileExtensionFromUri(getContext(), (Uri) object));
            FileUtils.saveAnswerFileFromUri((Uri) object, newFile, getContext());
