...
public class BuddhistDatePickerDialog extends CustomDatePickerDialog {
    ...
    protected void updateDays() {
        setUpDayPicker(getCurrentBuddhistDate());
    }
    ...
    private void setUpDatePicker() {
        LocalDateTime buddhistDate = DateTimeUtils
                ...
                .toLocalDateTime();
        setUpDayPicker(buddhistDate);
        setUpMonthPicker(buddhistDate, monthsArray);
        setUpYearPicker(buddhistDate, MIN_SUPPORTED_YEAR, MAX_SUPPORTED_YEAR);
    }
