    ...
    private CellData getCellData(String value, TreeElement element) {
        ...
        switch (element.getDataType()) {
            case Constants.DATATYPE_DATE:
                ...
                format.setType("DATE");
                format.setPattern("dd/mm/yy");
                cellData.setUserEnteredValue(new ExtendedValue().setStringValue(value));
                cellData.setUserEnteredFormat(new CellFormat().setNumberFormat(format));
                break;
            case Constants.DATATYPE_TIME:
                NumberFormat timeFormat = new NumberFormat();
                timeFormat.setType("TIME");
                cellData.setUserEnteredValue(new ExtendedValue().setStringValue(value));
                cellData.setUserEnteredFormat(new CellFormat().setNumberFormat(timeFormat));
                cellData.setEffectiveFormat(new CellFormat().setNumberFormat(timeFormat));
                break;
        }
        return cellData;
    }
