...
object DatabaseObjectMapper {
    ...
    fun getValuesFromForm(form: Form, formsPath: String): ContentValues {
        ...
        values.put(DatabaseFormColumns.EDITABLE, form.editable)
    ...
    fun getFormFromCurrentCursorPosition(
        ...
        val editableColumnIndex = cursor.getColumnIndex(DatabaseFormColumns.EDITABLE)
        ...
        return Form.Builder()
            ...
            .editable(cursor.getString(editableColumnIndex))
