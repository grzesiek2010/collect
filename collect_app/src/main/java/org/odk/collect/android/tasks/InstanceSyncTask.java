...
public class InstanceSyncTask extends AsyncTask<Void, String, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            File instancesPath = new File(new StoragePathProvider().getInstancesDirPath());
            if (instancesPath.exists() && instancesPath.isDirectory()) {
                ...
                try {
                    ...
                    while (instanceCursor.moveToNext()) {
                        String instanceFilename = new StoragePathProvider().getAbsoluteInstanceFilePath(instanceCursor.getString(
    ...
    private void encryptInstance(Cursor instanceCursor, String candidateInstance,
        ...
        if (!new File(instanceXml.getParentFile(), "submission.xml.enc").exists()) {
            ...
            if (formInfo != null) {
                ...
                StoragePathProvider storagePathProvider = new StoragePathProvider();
                instancesDao.updateInstance(values, InstanceColumns.INSTANCE_FILE_PATH + "=?", new String[]{storagePathProvider.getInstanceDbPath(candidateInstance)});
