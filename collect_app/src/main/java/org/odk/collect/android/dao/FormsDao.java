...
public class FormsDao {
    ...
    public Cursor getFormsCursorForFormFilePath(String formFilePath) {
        ...
        String[] selectionArgs = {new StoragePathProvider().getFormFilePathToStoreInDatabaseBasingOnRelativePath(new StoragePathProvider().getRelativeFormFilePath(formFilePath))};
