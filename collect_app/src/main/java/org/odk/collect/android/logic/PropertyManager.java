...
public class PropertyManager implements IPropertyManager {
    ...
    private MutableLiveData<Boolean> isPhoneStateNeeded = new MutableLiveData<>();
    ...
    public String getSingularProperty(String propertyName) {
        if (!permissionsProvider.isReadPhoneStatePermissionGranted() && isPropertyDangerous(propertyName)) {
            isPhoneStateNeeded.postValue(true);
        }
    ...
    public LiveData<Boolean> isPhoneStateNeeded() {
        return isPhoneStateNeeded;
    }
