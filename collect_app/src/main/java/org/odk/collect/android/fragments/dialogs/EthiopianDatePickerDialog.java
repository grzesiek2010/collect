...
public class EthiopianDatePickerDialog extends CustomDatePickerDialog {
    ...
    public static EthiopianDatePickerDialog newInstance(int widgetId, boolean isValueSelected, int day, int month, int year, boolean hideDay, boolean hideMonth) {
        EthiopianDatePickerDialog dialog = new EthiopianDatePickerDialog();
        dialog.setArguments(getArgs(widgetId, isValueSelected, day, month, year, hideDay, hideMonth));
    ...
    protected DateTime getDateAsGregorian() {
    ...
    protected void updateGregorianDateLabel() {
        gregorianDateText.setText(DateTimeUtils.getDateTimeBasedOnUserLocale(getDateAsGregorian().toLocalDate().toDate(), hideDay, hideMonth, false));
    }
}
