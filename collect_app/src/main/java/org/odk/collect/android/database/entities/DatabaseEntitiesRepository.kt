...
class DatabaseEntitiesRepository(context: Context, dbPath: String, private val clock: () -> Long) :
    ...
    private fun updatePropertyColumns(list: String, entity: Entity) {
        ...
        val missingColumns = expectedColumns
        ...
        val columnsToRemove = columnNames
        ...
        if (missingColumns.isNotEmpty()) {
            addPropertyColumns(list, missingColumns)
        }
        ...
        if (columnsToRemove.isNotEmpty()) {
            ...
            val remainingColumns = columnNames - columnsToRemove.toSet()
