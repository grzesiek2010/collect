    ...
    public synchronized Uri insert(@NonNull Uri uri, ContentValues initialValues) {
        ...
        if (formsDatabaseHelper != null) {
            ...
            if (!values.containsKey(FormsColumns.FORM_MEDIA_PATH)) {
                values.put(FormsColumns.FORM_MEDIA_PATH, StorageManager.getFormMediaFilePath(FileUtils.constructMediaPath(form.getName())));
            }
                    ...
                    try {
                        ...
                        if (del != null && del.getCount() > 0) {
                            ...
                            do {
                                ...
                                deleteFileOrDir(StorageManager.getAbsoluteFormMediaFilePath(del.getString(del
                        ...
                        if (c != null && c.getCount() > 0) {
                            ...
                            do {
                                ...
                                String formFilePath = c.getString(c
                                        .getColumnIndex(FormsColumns.FORM_FILE_PATH));
                                deleteFileOrDir(formFilePath);
                                deleteFileOrDir(StorageManager.getAbsoluteFormMediaFilePath(c.getString(c
                                        .getColumnIndex(FormsColumns.FORM_MEDIA_PATH))));
                                ...
                                try {
                                    ...
                                    ida.open();
                                    ida.delete(StorageManager.getAbsoluteFormMediaFilePath(c.getString(c
                                            .getColumnIndex(FormsColumns.FORM_MEDIA_PATH))
                                            + "/itemsets.csv"));
                                    ida.close();
                                } catch (Exception e) {
