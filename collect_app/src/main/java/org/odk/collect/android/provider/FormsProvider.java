    ...
    public synchronized Uri insert(@NonNull Uri uri, ContentValues initialValues) {
        ...
        if (formsDatabaseHelper != null) {
            ...
            if (!values.containsKey(FormsColumns.JRCACHE_FILE_PATH)) {
                String cachePath = StorageManager.getCacheFilePathColumnContent(md5 + ".formdef");
                values.put(FormsColumns.JRCACHE_FILE_PATH, cachePath);
            }
            if (!values.containsKey(FormsColumns.FORM_MEDIA_PATH)) {
                values.put(FormsColumns.FORM_MEDIA_PATH, StorageManager.getFormFilePathColumnContent(form.getName() + MEDIA_SUFFIX));
            }
                            ...
                            while (c.moveToNext()) {
                                ...
                                if (values.containsKey(FormsColumns.FORM_FILE_PATH)) {
                                    ...
                                    deleteFileOrDir(StorageManager.getAbsoluteCacheFilePath(c
                                            .getString(c.getColumnIndex(FormsColumns.JRCACHE_FILE_PATH))));
                                }
                            }
                        }
                    } finally {
                        ...
                        if (update != null && update.getCount() > 0) {
                            ...
                            if (values.containsKey(FormsColumns.JRCACHE_FILE_PATH)) {
                                deleteFileOrDir(StorageManager.getAbsoluteCacheFilePath(update
                                        .getString(update.getColumnIndex(FormsColumns.JRCACHE_FILE_PATH))));
                            }
                            ...
                            if (values.containsKey(FormsColumns.FORM_FILE_PATH)) {
                                ...
                                values.put(FormsColumns.JRCACHE_FILE_PATH,
                                        StorageManager.getCacheFilePathColumnContent(newMd5 + ".formdef"));
                            }
