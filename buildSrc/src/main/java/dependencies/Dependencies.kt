...
object Dependencies {
    ...
    const val androidx_browser = "androidx.browser:browser:1.3.0" // Upgrading will require compileSdk 31
    ...
    const val androidx_appcompat = "androidx.appcompat:appcompat:1.3.1" // Upgrading will require compileSdk 31
    ...
    const val android_material = "com.google.android.material:material:1.4.0" // Upgrading will require compileSdk 31
    const val android_flexbox = "com.google.android.flexbox:flexbox:3.0.0"
    const val google_api_client_android = "com.google.api-client:google-api-client-android:1.33.1"
    const val google_api_services_drive = "com.google.apis:google-api-services-drive:v3-rev20220110-1.32.1"
    const val google_api_services_sheets = "com.google.apis:google-api-services-sheets:v4-rev20210629-1.32.1"
    const val play_services_auth = "com.google.android.gms:play-services-auth:20.0.1"
    ...
    const val burgstaller_okhttp_digest = "io.github.rburgst:okhttp-digest:2.6"
    ...
    const val opencsv = "com.opencsv:opencsv:5.5.2"
    ...
    const val firebase_analytics = "com.google.firebase:firebase-analytics:20.0.2"
    const val firebase_crashlytics = "com.google.firebase:firebase-crashlytics:18.2.7"
    ...
    const val kotlinx_coroutines_test = "org.jetbrains.kotlinx:kotlinx-coroutines-test:1.6.0"
